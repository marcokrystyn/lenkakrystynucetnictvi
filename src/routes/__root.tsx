...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "BlxuGKS5j2VSbAk9vuDN4nkMcsD6hCl8s5k1BYLADZU" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", href: "/favicon-lk.ico", type: "image/x-icon" },
      { rel: "icon", href: "/favicon-lk.png", type: "image/png", sizes: "32x32" },
    ],
  }),
